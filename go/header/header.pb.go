...
var file_header_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x62, 0x75, 0x66, 0x66, 0x22, 0xa0, 0x01, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x12, 0x29, 0x0a, 0x03, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17,
	0x2e, 0x64, 0x65, 0x62, 0x75, 0x66, 0x66, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4d,
	...
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x64, 0x65, 0x62, 0x75, 0x66,
	0x66, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05,
...
var file_header_proto_goTypes = []interface{}{
	(*Header)(nil),       // 0: debuff.Header
	(*Header_Value)(nil), // 1: debuff.Header.Value
	nil,                  // 2: debuff.Header.MapEntry
}
var file_header_proto_depIdxs = []int32{
	2, // 0: debuff.Header.map:type_name -> debuff.Header.MapEntry
	1, // 1: debuff.Header.MapEntry.value:type_name -> debuff.Header.Value
