...
type Tool struct {
	...
	TimeLimitSeconds uint32 `protobuf:"varint,6,opt,name=time_limit_seconds,proto3" json:"time_limit_seconds,omitempty"`
...
func (x *Tool) GetTimeLimitSeconds() uint32 {
	if x != nil {
...
var file_tools_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x74,
