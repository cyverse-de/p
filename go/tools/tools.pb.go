...
const file_tools_proto_rawDesc = "" +
	"\n" +
	"\vtools.proto\x12\x05tools\x1a\n" +
	"apps.proto\x1a\x10containers.proto\"\xa0\x03\n" +
	"\x04Tool\x12\x12\n" +
	...
	"\x12time_limit_seconds\x18\x06 \x01(\x05R\x12time_limit_seconds\x12\x1e\n" +
	"\n" +
	"restricted\x18\a \x01(\bR\n" +
	"restricted\x12 \n" +
	"\vinteractive\x18\b \x01(\bR\vinteractive\x12 \n" +
	"\vgpu_enabled\x18\t \x01(\bR\vgpu_enabled\x12A\n" +
	"\x10integration_data\x18\n" +
	" \x01(\v2\x15.apps.IntegrationDataR\x10integration_data\x12;\n" +
	"\x0fcontainer_image\x18\v \x01(\v2\x11.containers.ImageR\x0fcontainer_imageBN\n" +
	"\x18org.cyverse.de.protobufsB\x0eToolsProtobufsP\x01Z github.com/cyverse-de/p/go/toolsb\x06proto3"
