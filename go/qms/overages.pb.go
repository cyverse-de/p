...
type Overage struct {
	...
	Quota        float32                `protobuf:"fixed32,4,opt,name=quota,proto3" json:"quota,omitempty"`
...
func (x *Overage) GetHeader() *header.Header {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *Overage) GetError() *svcerror.ServiceError {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_qms_overages_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa1, 0x01, 0x0a, 0x07, 0x4f, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x1f,
	...
	0x72, 0x72, 0x6f, 0x72, 0x12, 0x24, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75,
	0x6f, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x71, 0x75, 0x6f, 0x74, 0x61,
	0x12, 0x14, 0x0a, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52,
	0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x22, 0x79, 0x0a, 0x0b, 0x4f, 0x76, 0x65, 0x72, 0x61, 0x67,
	0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18,
	...
	,
...
var file_qms_overages_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_qms_overages_proto_goTypes = []interface{}{
	(*Overage)(nil),               // 0: Overage
	(*OverageList)(nil),           // 1: OverageList
	(*IsOverage)(nil),             // 2: IsOverage
	(*header.Header)(nil),         // 3: Header
	(*svcerror.ServiceError)(nil), // 4: ServiceError
}
var file_qms_overages_proto_depIdxs = []int32{
	3, // 0: Overage.header:type_name -> Header
	4, // 1: Overage.error:type_name -> ServiceError
	3, // 2: OverageList.header:type_name -> Header
	4, // 3: OverageList.error:type_name -> ServiceError
	0, // 4: OverageList.overages:type_name -> Overage
	3, // 5: IsOverage.header:type_name -> Header
	4, // 6: IsOverage.error:type_name -> ServiceError
