...
func file_groups_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_groups_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PermissionGrantRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_groups_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PermissionPutRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_groups_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AbbreviatedPermission); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_groups_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AbbreviatedPermissionList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
