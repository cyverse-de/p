...
const file_analysis_record_proto_rawDesc = "" +
	"\n" +
	"\x15analysis_record.proto\x12\banalysis\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\n" +
	"user.proto\x1a\n" +
	"apps.proto\"y\n" +
	"\vBatchStatus\x12\x14\n" +
	...
	"\tsubmitted\x18\x04 \x01(\x03R\tsubmitted\"P\n" +
	"\fAnalysisType\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1c\n" +
	"\tsystem_id\x18\x03 \x01(\tR\tsystem_id\"\x90\x05\n" +
	"\bAnalysis\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1b\n" +
	"\x03app\x18\x04 \x01(\v2\t.apps.AppR\x03app\x122\n" +
	"\vapp_version\x18\x05 \x01(\v2\x10.apps.AppVersionR\vapp_version\x12*\n" +
	"\x04kind\x18\x06 \x01(\v2\x16.analysis.AnalysisTypeR\x04type\x12.\n" +
	"\x12result_folder_path\x18\a \x01(\tR\x12result_folder_path\x12:\n" +
	"\n" +
	"start_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"start_date\x126\n" +
	"\bend_date\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\bend_date\x12F\n" +
	"\x10planned_end_date\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\x10planned_end_date\x12\x16\n" +
	"\x06status\x18\v \x01(\tR\x06status\x12\x18\n" +
	"\adeleted\x18\f \x01(\bR\adeleted\x12\x16\n" +
	"\x06notify\x18\r \x01(\bR\x06notify\x12\x1e\n" +
	"\x04user\x18\x0e \x01(\v2\n" +
	".user.UserR\x04user\x12\x1c\n" +
	"\tsubdomain\x18\x0f \x01(\tR\tsubdomain\x12\x1c\n" +
	"\tparent_id\x18\x10 \x01(\tR\tparent_id\x12/\n" +
	"\x13millicores_reserved\x18\x11 \x01(\x01R\x12millicore_reservedBZ\n" +
	"\x18org.cyverse.de.protobufsB\x17AnalysisRecordProtobufsP\x01Z#github.com/cyverse-de/p/go/analysisb\x06proto3"

var (
	file_analysis_record_proto_rawDescOnce sync.Once
	file_analysis_record_proto_rawDescData []byte
)

func file_analysis_record_proto_rawDescGZIP() []byte {
	file_analysis_record_proto_rawDescOnce.Do(func() {
		file_analysis_record_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_analysis_record_proto_rawDesc), len(file_analysis_record_proto_rawDesc)))
	})
...
func file_analysis_record_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_analysis_record_proto_rawDesc), len(file_analysis_record_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
