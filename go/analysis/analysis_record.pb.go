...
type Analysis struct {
	...
	Type *AnalysisType `protobuf:"bytes,6,opt,name=type,proto3" json:"type,omitempty"`
...
func (x *Analysis) GetType() *AnalysisType {
	if x != nil {
		return x.Type
	}
	return nil
...
var file_analysis_record_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x70, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x04, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x61, 0x6e, 0x61, 0x6c,
...
var file_analysis_record_proto_depIdxs = []int32{
	...
	1, // 2: analysis.Analysis.type:type_name -> analysis.AnalysisType
