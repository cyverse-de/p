...
const file_analysis_requests_proto_rawDesc = "" +
	"\n" +
	"\x17analysis_requests.proto\x12\banalysis\x1a\fheader.proto\x1a\x15analysis_record.proto\x1a\x0esvcerror.proto\"\xfb\x01\n" +
	"\x1bAnalysisRecordLookupRequest\x12!\n" +
	"\vanalysis_id\x18\x01 \x01(\tH\x00R\n" +
	"analysisId\x12!\n" +
	"\vexternal_id\x18\x02 \x01(\tH\x00R\n" +
	"externalId\x12\x19\n" +
	"\auser_id\x18\x03 \x01(\tH\x00R\x06userId\x12\x1c\n" +
	"\busername\x18\x04 \x01(\tH\x00R\busername\x12&\n" +
	"\x06header\x18\x05 \x01(\v2\x0e.header.HeaderR\x06header\x12'\n" +
	"\x0frequesting_user\x18\x06 \x01(\tR\x0erequestingUserB\f\n" +
	"\n" +
	"lookup_ids\"\xed\x02\n" +
	"\x16AnalysisRecordResponse\x12&\n" +
	"\x06header\x18\x01 \x01(\v2\x0e.header.HeaderR\x06header\x12.\n" +
	"\banalyses\x18\x02 \x03(\v2\x12.analysis.AnalysisR\banalyses\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\tR\ttimestamp\x12\x14\n" +
	"\x05total\x18\x04 \x01(\x03R\x05total\x12V\n" +
	"\fstatus_count\x18\x05 \x03(\v22.analysis.AnalysisRecordResponse.StatusCountRecordR\fstatus-count\x12,\n" +
	"\x05error\x18\x06 \x01(\v2\x16.svcerror.ServiceErrorR\x05error\x1aA\n" +
	"\x11StatusCountRecord\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x03R\x05count\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"\x9a\x01\n" +
	"\x12AnalysisRecordList\x12&\n" +
	"\x06header\x18\x01 \x01(\v2\x0e.header.HeaderR\x06header\x12.\n" +
	"\banalyses\x18\x02 \x03(\v2\x12.analysis.AnalysisR\banalyses\x12,\n" +
	"\x05error\x18\a \x01(\v2\x16.svcerror.ServiceErrorR\x05errorB[\n" +
	"\x18org.cyverse.de.protobufsB\x18AnalysisRequestProtobufsP\x01Z#github.com/cyverse-de/p/go/analysisb\x06proto3"
