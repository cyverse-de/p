...
impl serde::Serialize for SavedSearchesStorage {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user.SavedSearchesStorage", len)?;
        if !self.uuid.is_empty() {
            struct_ser.serialize_field("uuid", &self.uuid)?;
        }
        if !self.user_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SavedSearchesStorage {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SavedSearchesStorage;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user.SavedSearchesStorage")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SavedSearchesStorage, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
        ...
        deserializer.deserialize_struct("user.SavedSearchesStorage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SavedSearchesWire {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user.SavedSearchesWire", len)?;
        if let Some(v) = self.user.as_ref() {
            struct_ser.serialize_field("user", v)?;
        }
        if !self.saved_searches.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SavedSearchesWire {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SavedSearchesWire;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user.SavedSearchesWire")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SavedSearchesWire, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut user__ = None;
                ...
                Ok(SavedSearchesWire {
                    user: user__,
                    saved_searches: saved_searches__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("user.SavedSearchesWire", FIELDS, GeneratedVisitor)
    }
}
